#!/usr/bin/env python3
"""Guarded fail-closed entrypoint for full-encoder delta C0 calibration."""
...
from clinical_jepa.eval.j04c_l1avg_delta_c0cal import (
    ApprovedSeedEnvelope, FAILURE_CODES, PrototypeInvariantError,
    approved_envelope_from_dict, build_provenance_from_dict, failure_artifact,
    run_beta, seed_manifest_from_dict, validate_seed_audit, validate_success_schema,
)
