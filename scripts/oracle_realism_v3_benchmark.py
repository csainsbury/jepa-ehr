...
def main():
    ...
    from scripts.oracle_realism_v3_engine import (ESTIMATORS as _EST, SOURCE_IDENTITY_BUNDLE,
                                                   ESTIMATOR_DEPENDENCY_IDENTITY)
    ...
    config_identity = canonical_hash({
        ...
        # Pi rev-12 #3 / rev-13 #3: the DETERMINISTIC config_identity binds the four SOURCE identity layers only —
        # never a version-bearing hash. The environment-dependent dependency identity goes in the timing artifact below.
