#!/usr/bin/env python3
"""Guarded fail-closed entrypoint for the BP011 C0 assay-calibration beta."""
...
from clinical_jepa.eval.j04c_v3_r0resid_c0cal import (
    C0CalApprovedSeedEnvelope, FAILURE_CODES, PrototypeInvariantError,
    approved_envelope_from_dict, build_provenance_from_dict, failure_artifact,
    run_c0cal_beta, seed_manifest_from_dict, validate_seed_audit, validate_success_schema,
)
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        ...
        envelope: C0CalApprovedSeedEnvelope = approved_envelope_from_dict(envelope_value)
