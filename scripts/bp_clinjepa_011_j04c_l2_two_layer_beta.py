#!/usr/bin/env python3
"""Find the smallest genuine L2 separation beta using maximally separated teacher layers 1 and 4."""
...
G=1102;MODELS=(2101,2102,2103);READOUT=2102;RECIPE='L2_SEP';LAYERS=(1,4);WEIGHT=10.;FLOOR=.01;UNTRAINED=(0.7753685818549992,0.7805427899230244,0.75101867607262)
